...
--	====================
		...
		BaseDamage = 29;
		FireRate = 0.19 ; --In second
		ReloadTime = 4; --In second
		AmmoPerClip = 15; --Put "math.huge" to make this gun has infinite ammo and never reload
